...
@Config
@Autonomous(name="Autonom Storage Rosu", group="Auto")
///@Disabled
public class Autonom_Storage_Rosu extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence myTrajectory = drive.trajectorySequenceBuilder(new Pose2d(-34, -63, Math.toRadians(90)))
        ...
        if (opModeIsActive()) {
            ...
            if (rectangleArea >= minRectangleArea) {
                if (pipeline.getRectMidpointX() > 5 && pipeline.getRectMidpointX() < 155) {
                    telemetry.addData("TSE", "Mid");
                    preload = 2;

                } else if (pipeline.getRectMidpointX() >= 155 && pipeline.getRectMidpointX() < 456) {
