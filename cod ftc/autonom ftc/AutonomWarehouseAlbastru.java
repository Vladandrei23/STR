...
@Autonomous(name="Autonom Warehouse Albastru", group = "advanced")
public class AutonomWarehouseAlbastru extends LinearOpMode {
    ...
    Pose2d startPose = new Pose2d(10, 66, Math.toRadians(270));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory trajectory1caz1 = drive.trajectoryBuilder(new Pose2d(10, 66, Math.toRadians(270)))
                .lineToLinearHeading(new Pose2d(0, 49, Math.toRadians(250)))
                .build();
        ...
        Trajectory trajectory1caz2 = drive.trajectoryBuilder(new Pose2d(10, 66, Math.toRadians(270)))
                .lineToLinearHeading(new Pose2d(0, 54, Math.toRadians(250)))
                .build();

        Trajectory fataputint1c2 = drive.trajectoryBuilder(trajectory1caz2.end())
                .lineToLinearHeading(new Pose2d(0, 48, Math.toRadians(250)))
                .build();
        ...
        Trajectory trajectory1caz3 = drive.trajectoryBuilder(new Pose2d(10, 66, Math.toRadians(270)))
                .lineToLinearHeading(new Pose2d(0, 56, Math.toRadians(250)))
                .build();

        Trajectory fataputint1c3 = drive.trajectoryBuilder(trajectory1caz3.end())
                .lineToLinearHeading(new Pose2d(0, 47, Math.toRadians(250)))
                .build();
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            if (rectangleArea >= minRectangleArea) {
                if (pipeline.getRectMidpointX( ) >= 10 && pipeline.getRectMidpointX() < 155) { // * pipeline.getRectWidth()
                    telemetry.addData("TSE", "Mid");
                    preload = 2;
                } else if (pipeline.getRectMidpointX() >= 155) {
                    telemetry.addData("TSE", "High");
                    preload = 1;
                } else if (pipeline.getRectMidpointX() < 10) {
                ...
                case TRAJECTORY_2:
                    if (once == 0) {
                        TrajectorySequence TrajectorySeqSpreHub = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                                .lineToLinearHeading(new Pose2d(10, 66, Math.toRadians(180)))
                                .lineToLinearHeading(new Pose2d(0, 47, Math.toRadians(240)))
                                .build();
